    ...
    >
      <div className="w-full max-w-sm space-y-5">
        <div className="text-center">
          <p style={{ fontFamily: "'Playfair Display',serif", fontSize: '1.6rem', fontWeight: 900 }}>
            P&amp;S
          </p>
        ...
        {mode === 'choose' && (
          <div className="space-y-3">
            <button
              ...
              disabled={busy}
              className="w-full border rounded py-2.5 flex items-center justify-center gap-2 disabled:opacity-50"
            >
